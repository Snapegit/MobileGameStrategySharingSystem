	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="lable">游戏名称：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}' class="text">{{detail.youximingcheng}}</view>
				</view>
				<view :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="lable">发布日期：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}' class="text">{{detail.faburiqi}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>游戏分类：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.youxifenlei}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>游戏平台：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.youxipingtai}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>游戏背景：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.youxibeijing}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>角色扮演：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.jiaosebanyan}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>角色介绍：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.jiaosejieshao}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.yonghuzhanghao}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.yonghuxingming}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view :style='{"padding":"0 40rpx 0 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","textAlign":"center","display":"inline-block","justifyContent":"center","borderRadius":"100rpx","borderWidth":"0 0 0px 0","background":"#3da74210","width":"48%","borderStyle":"solid","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag">
					...
					<view :style='{"width":"auto","flex":"1","display":"inline-block","height":"auto"}'>
						...
						<view :style='{"lineHeight":"80rpx","fontSize":"48rpx","color":"#333333","display":"inline-block"}' class="iconfont icon-thumb-up-line2" @click="zan"></view>
					</view>
				</view>
				<view :style='{"padding":"0 40rpx 0 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","textAlign":"center","display":"inline-block","justifyContent":"center","borderRadius":"100rpx","borderWidth":"0 0 0px 0","background":"#3da74210","width":"48%","borderStyle":"solid","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag">
					...
					<view :style='{"width":"auto","flex":"1","display":"inline-block","height":"auto"}'>
						<view :style='{"margin":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","display":"inline-block"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"48rpx","color":"#333333","display":"inline-block"}' class="iconfont icon-thumb-up-fill3" @click="zan"></view>
					</view>
				</view>
				<view :style='{"padding":"0 40rpx 0 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","borderRadius":"100rpx","textAlign":"center","borderWidth":"0 0 0px 0","background":"#3da74210","display":"inline-block","width":"48%","borderStyle":"solid","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag">
					...
					<view :style='{"width":"auto","flex":"1","display":"inline-block","height":"auto"}'>
						...
						<view :style='{"lineHeight":"80rpx","fontSize":"48rpx","color":"#333333","display":"inline-block"}' class="iconfont icon-thumb-down-line2" @click="cai"></view>
					</view>
				</view>
				<view :style='{"padding":"0 40rpx 0 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","borderRadius":"100rpx","textAlign":"center","borderWidth":"0 0 0px 0","background":"#3da74210","display":"inline-block","width":"48%","borderStyle":"solid","height":"auto"}' class="detail-list-item" v-if="crazilyFlag">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333333","textAlign":"left","display":"inline-block","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">踩：</view>
					<view :style='{"width":"auto","flex":"1","display":"inline-block","height":"auto"}'>
						<view :style='{"margin":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","display":"inline-block"}'>{{detail.crazilynum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"48rpx","color":"#333333","display":"inline-block"}' class="iconfont icon-thumb-down-fill2" @click="cai"></view>
					</view>
				</view>
				...
				<view class="detail-list-item video" :style='{"margin":"0 0 24rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<video :style='{"border":"0","width":"100%","margin":"0 0 0 0","outline":"none","borderRadius":"8rpx","display":"block"}' id="myVideo" :src="baseUrl+detail.shipin" controls></video>
				</view>

				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>技巧攻略</view>
					<view class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666"}'>{{detail.jiqiaogonglve}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"24rpx 0 24rpx 0","borderColor":"#cccccc","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 0px 0","background":"#ffffff","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 24rpx 0 24rpx","margin":"0 0 12rpx","color":"#333333","textAlign":"left","background":"#3da74210","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}'>流程分析</view>
					<view class="rich-text" :style='{"padding":"0px 24rpx 24rpx","margin":"0 0 0 0","lineHeight":"48rpx","color":"#666666"}'>
						<rich-text :nodes="detail.liuchengfenxi"></rich-text>
					</view>
				</view>
				<view class="detail-list-item rich" :style='{"margin":"24rpx 0 24rpx 0","borderColor":"#cccccc","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 0px 0","background":"#ffffff","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 24rpx 0 24rpx","margin":"0 0 12rpx","color":"#333333","textAlign":"left","background":"#3da74210","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}'>关键点提示</view>
					<view class="rich-text" :style='{"padding":"0px 24rpx 24rpx","margin":"0 0 0 0","lineHeight":"48rpx","color":"#666666"}'>
						<rich-text :nodes="detail.guanjiandiantishi"></rich-text>
					</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			this.getThumbsup();
			let cleanType = uni.getStorageSync('discussyouxigonglveCleanType')
			if(cleanType){
				uni.removeStorageSync('discussyouxigonglveCleanType')
				this.mescroll.num = 1
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('youxigonglve', this.id);
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','youxigonglve');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('youxigonglve',_this.detail)
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.add('storeup', {
								userid: _this.user.id,
								name: _this.detail.youximingcheng,
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				uni.setStorageSync('crossTable','youxigonglve');
			...
			async init(){
				...
				let res = await this.$api.info('youxigonglve', this.id);
				this.detail = res.data;
				// 轮播图片
				this.swiperList = this.detail.youxitupian ? this.detail.youxitupian.split(",") : [];
				//修改富文本的图片样式
				this.detail.liuchengfenxi = this.detail.liuchengfenxi.replace(/img src/gi,"img style=\"width:100%;\" src");
				//修改富文本的图片样式
				this.detail.guanjiandiantishi = this.detail.guanjiandiantishi.replace(/img src/gi,"img style=\"width:100%;\" src");
			},
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussyouxigonglve', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			async onCommentTap() {
				...
				this.$utils.jump(`../discussyouxigonglve/add-or-update?refid=${this.id}`)
			},
			// 获取赞踩
			async getThumbsup() {
				if(!this.user){
