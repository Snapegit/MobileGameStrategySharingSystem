	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"12rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","background":"#3da742","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>游戏攻略</view>
				<text :style='{"width":"100%","margin":"20rpx 0 0 0","fontSize":"28rpx","lineHeight":"48rpx","color":"#666","display":"block"}' @tap="onPageTap('youxigonglve')">查看更多</text>
			</view>
		  ...
		  <view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<view @tap="onDetailTap('youxigonglve',product.id)" v-for="(product,index) in homeyouxigonglvelist" :key="index" class="list-item" :style='{"border":"2rpx solid #3da74250","boxShadow":"0 0px 0px #cccccc","padding":"20rpx","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
			                			  <view :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 20rpx 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"0px","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}' class="list-item-title ">{{product.youximingcheng}}</view>
			  			  			  			                			  			  			                			  			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.youxitupian.substring(0,4)=='http'" :src="product.youxitupian"></image>
			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.youxitupian?baseUrl+product.youxitupian.split(',')[0]:''"></image>
			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  <view :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 20rpx 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"0px","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}' class="list-item-title ">发布日期:{{product.faburiqi}}</view>
			  			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			  			</view>
		  </view>
		...
		<!-- 新闻资讯 -->
																		<view class="listBox news" :style='{"width":"100%","margin":"40rpx 0 40rpx 0","background":"#ffffff","order":"6"}'>
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","background":"#3da742","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>游戏资讯</view>
				<text :style='{"width":"100%","margin":"20rpx 0 0 0","fontSize":"28rpx","lineHeight":"48rpx","color":"#666666","display":"block"}' @tap="onPageTap('news')">查看更多</text>
			</view>
		  ...
		  <!-- 样式6 -->
		  		  <view class="news-box3" :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 80rpx 0","height":"auto"}'>
			<view @tap="onNewsDetailTap(item.id)" v-for="(item,index) in news" :key="index" class="list-item" :style='{"padding":"0px 12rpx 0px 12rpx","margin":"0 0 0 0","borderColor":"#3da74230","backgroundColor":"#fff","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","position":"relative","borderStyle":"solid","justifyContent":"space-between","height":"100rpx"}'>
			  <view :style='{"width":"12rpx","padding":"0 0 0 0","margin":"36rpx 20rpx 0 0","backgroundColor":"#3da742","borderRadius":"12rpx","height":"12rpx"}' class="dian"></view>
			  <view :style='{"overflow":"hidden","whiteSpace":"nowrap","color":"#333","flex":"1","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"80rpx"}' class="title ">{{item.title}}</view>
			  <i class="iconfont icon-gengduo1" :style='{"width":"32rpx","padding":"0 0 0 0","margin":"0px 0 0 0","lineHeight":"80rpx","fontSize":"32rpx","color":"#3da74250"}'></i>
			</view>
		  </view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			res = await this.$api.list('youxigonglve', {
				page: 1,
        sort: 'thumbsupnum',
        order: 'desc',
			...
			this.homeyouxigonglvelist = res.data.list
		},
